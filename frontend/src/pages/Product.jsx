    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:flex-row flex-col">
        ...
        <div className="flex-1">
          ...
          <button onClick={()=> addToCart(productData._id, size)} className="bg-[#C586A5]  text-white px-8 py-3 text-sm active:bg-[#9B6A83]">
            {" "}
            ADD TO CART{" "}
          </button>
          <hr className="mt-8 sm:w-4/5" />
          <div className="text-sm text-gray-500 mt-5 flex flex-col gap-1">
            <p> 24/7 Express Delivery</p>
            <p> Delivery in 20-50 minutes within Nairobi</p>
            <p> Next-day country-wide delivery (order before 4pm)</p>
          </div>
        </div>
      </div>
